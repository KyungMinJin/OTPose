...
import os
from utils.setup import CfgNode
...
_C.MODEL.DEFORMABLE_CONV_CH = 64
_C.MODEL.OFFSET_MASK_COMBINE_CONV = 2

#### LOSS ####
_C.LOSS = CfgNode()
_C.LOSS.NAME = 'ST_OHKW_MSELoss'
...
_C.TRAIN.LR_SCHEDULER = 'CosineAnnealingLR'
_C.TRAIN.EPOCHS = 30
